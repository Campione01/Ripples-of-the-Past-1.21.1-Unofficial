...
public class HamonBubbleCutterModel extends HierarchicalModel<HamonBubbleCutterEntity> {
    private final ModelPart root;
    private final ModelPart cutter;

    public HamonBubbleCutterModel(ModelPart root) {
        this.root = root;
        this.cutter = root.getChild("cutter");
    }

    public static HamonBubbleCutterModel create() {
        return new HamonBubbleCutterModel(createBodyLayer().bakeRoot());
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        mesh.getRoot().addOrReplaceChild("cutter", CubeListBuilder.create()
                ...
                .texOffs(0, 12).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.2F)),
                PartPose.ZERO);
    ...
    @Override
    public void setupAnim(HamonBubbleCutterEntity entity, float walkAnimPos, float walkAnimSpeed,
