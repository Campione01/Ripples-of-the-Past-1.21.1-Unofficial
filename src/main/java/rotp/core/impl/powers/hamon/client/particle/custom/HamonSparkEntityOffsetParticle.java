...
import rotp.core.client.particle.type.custom.EntityOffsetParticle;
...
public class HamonSparkEntityOffsetParticle extends EntityOffsetParticle {
	...
	public HamonSparkEntityOffsetParticle(ClientLevel level, Entity entity, 
		...
		double f1 = Math.sqrt(this.xd * this.xd + this.yd * this.yd + this.zd * this.zd);
