...
abstract class PillarmanActionAbility extends EntityActionAbility {
	...
	public boolean canContinueAction(EntityActionInstance action) {
		rotp.core.powersystem.entityaction.ActionPhase phase = action.getPhase();
		boolean checkOngoingRequirements = phase == rotp.core.powersystem.entityaction.ActionPhase.BUTTON_CHARGE
				|| phase == rotp.core.powersystem.entityaction.ActionPhase.PERFORM
	...
	protected static class PillarmanHeldActionInstance extends EntityActionInstance {
		...
		@Override
		public void onSetPhase(rotp.core.powersystem.entityaction.ActionPhase newPhase) {
			PillarmanActionAbility pillarmanAbility = pillarmanAbility();
			if (pillarmanAbility != null
					&& newPhase == rotp.core.powersystem.entityaction.ActionPhase.PERFORM) {
		...
		public void actionTick() {
			if (getPhase() != rotp.core.powersystem.entityaction.ActionPhase.PERFORM) {
				return;
			}
