package rotp.core.impl.powers.pillarman.client.particles;

import java.util.Random;

import rotp.core.client.particle.type.RisingParticleOld;
import rotp.core.impl.powers.hamon.client.particle.custom.HamonAuraParticleRenderType;
...
public class LightGlintParticle extends RisingParticleOld {
	private static final Random RANDOM = new Random();
	private final int startingSpriteRandom;

	protected LightGlintParticle(ClientLevel level, double x, double y, double z, 
	...
	public static class Factory implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			LightGlintParticle particle = new LightGlintParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
			return particle;
		}
	}
}
