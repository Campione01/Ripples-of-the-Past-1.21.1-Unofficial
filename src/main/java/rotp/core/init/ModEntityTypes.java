...
import rotp.core.customobjects.entity_projectile.BlockShardEntity;
...
import rotp.core.customobjects.entity_projectile.MolotovEntity;
...
import rotp.core.customobjects.entity_projectile.ThrownNuggetBearingEntity;
import rotp.core.mechanics.clothes.mannequin.MannequinEntity;
...
import rotp.core.impl.stands.crazydiamond.CrazyDBlockBulletEntity;
import rotp.core.impl.stands.crazydiamond.CrazyDBloodCutterEntity;
import rotp.core.impl.stands.crazydiamond.CrazyDEyeOfEnderInsideEntity;
import rotp.core.impl.stands.crazydiamond.CrazyDFireworkInsideEntity;
import rotp.core.impl.stands.hierophant.HGBarrierEntity;
import rotp.core.impl.stands.hierophant.HGEmeraldEntity;
import rotp.core.impl.stands.hierophant.HGGrappleEntity;
...
import rotp.core.impl.stands.magiciansred.MRDetectorEntity;
import rotp.core.impl.npc.rps.RockPaperScissorsKidEntity;
import rotp.core.impl.stands.magiciansred.MRRedBindEntity;
...
import rotp.core.worldgen.structure.PillarmanTempleEngravingEntity;
...
//			.noLootTable()
	...
	public static final DeferredHolder<EntityType<?>, EntityType<rotp.core.impl.stands.goldexperience.GETransformationEntity>> GE_LIFEFORM_TRANSFORMATION = ENTITY_TYPES.register("ge_lifeform", key ->
			EntityType.Builder.<rotp.core.impl.stands.goldexperience.GETransformationEntity>of(rotp.core.impl.stands.goldexperience.GETransformationEntity::new, MobCategory.MISC)
			.sized(1.0F, 1.0F)
			.noSummon()
			.clientTrackingRange(32)
			.build(createIDFor(key)));
