...
import rotp.core.client.entityanim.action.AnimActionPhase;
...
import rotp.core.client.entityrender.HiddenModelPartsUtil;
...
//	public float animTime;
	...
	public void initStaticPoses(FloatList poseTimestamps) {
		if (poseTimestamps != null) {
			...
			// (evaluateQueries goes through AnimMolangQuery.instance, whose query context is
