package rotp.core.client.entityanim.gecko;
...
public class MoarInterpolations {
	...
	public static final Interpolation LINEAR = addLerpMode("linear", AnimationChannel.Interpolations.LINEAR);
	
	public static final Interpolation CATMULLROM = addLerpMode("catmullrom", AnimationChannel.Interpolations.CATMULLROM);
