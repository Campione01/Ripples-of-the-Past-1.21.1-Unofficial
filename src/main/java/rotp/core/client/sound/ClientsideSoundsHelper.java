...
import rotp.core.client.standskin.sound.SoundInstanceWithStandSkin;
import rotp.core.client.sound.sounds.EntityStoppableSoundInstance;
import rotp.core.core.JojoMod;
import rotp.core.mixin.client.time.AbstractSoundInstanceRegionalTimeDilationAccessor;
...
public class ClientsideSoundsHelper {
	...
	public static void onSoundPlayed(PlaySoundEvent event) {
		...
		if (rotp.core.client.ClientTimeStopHandler.shouldCancelSound(event.getSound())) {
			event.setSound(null);
		}
