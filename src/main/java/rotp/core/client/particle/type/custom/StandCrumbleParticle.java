package rotp.core.client.particle.type.custom;
...
public class StandCrumbleParticle extends SingleQuadParticle {
	...
	public StandCrumbleParticle(ClientLevel level, double pX, double pY, double pZ) {
		super(level, pX, pY, pZ);
	}

	public StandCrumbleParticle(ClientLevel level, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
