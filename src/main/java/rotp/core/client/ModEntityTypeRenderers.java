...
import rotp.core.adventure.npc.client.CharacterMobRenderer;
import rotp.core.client.entityrender.entities.AfterimageRenderer;
import rotp.core.client.entityrender.entities.BladeHatEntityModel;
import rotp.core.client.entityrender.entities.BladeHatRenderer;
import rotp.core.client.entityrender.entities.BlockShardRenderer;
import rotp.core.client.entityrender.entities.ClackersModel;
import rotp.core.client.entityrender.entities.ClackersRenderer;
import rotp.core.client.entityrender.entities.KnifeRenderer;
import rotp.core.client.entityrender.entities.LightBeamRenderer;
import rotp.core.client.entityrender.entities.MRFlameRenderer;
import rotp.core.client.entityrender.entities.MannequinRenderer;
import rotp.core.client.entityrender.entities.MolotovRenderer;
import rotp.core.client.entityrender.entities.NoopEntityRenderer;
import rotp.core.client.entityrender.entities.PillarmanTempleEngravingRenderer;
import rotp.core.client.entityrender.entities.RoadRollerModel;
import rotp.core.client.entityrender.entities.RoadRollerRenderer;
import rotp.core.client.entityrender.entities.SCFlameRenderer;
import rotp.core.client.entityrender.entities.SimpleEntityModel;
import rotp.core.client.entityrender.entities.SimpleEntityRenderer;
import rotp.core.client.entityrender.entities.SpaceRipperStingyEyesRenderer;
import rotp.core.client.entityrender.entities.StandArrowRenderer;
import rotp.core.client.entityrender.entities.TommyGunBulletRenderer;
import rotp.core.client.entityrender.entities.v1_21_2plus.MannequinModel_1_21_2plus;
...
import rotp.core.client.render.armor.model.StoneMaskArmorModel;
import rotp.core.core.JojoMod;
import rotp.core.init.ModEntityTypes;
import rotp.core.mechanics.clothes.client.layer.HumanoidClothesLayer;
import rotp.core.mrpresident.client.CocoJumboTurtleModel;
import rotp.core.mrpresident.client.CocoJumboTurtleRenderer;
import rotp.core.subsystems.soul.client.SoulRenderer;
import rotp.core.impl.stands.crazydiamond.client.AngeloRockRenderer;
import rotp.core.impl.stands.crazydiamond.client.CrazyDBlockBulletRenderer;
import rotp.core.impl.stands.hierophant.client.HGBarrierRenderer;
import rotp.core.impl.stands.hierophant.client.HGGrappleRenderer;
import rotp.core.impl.stands.hierophant.client.HGStringRenderer;
import rotp.core.impl.stands.goldexperience.client.GETransformationRenderer;
import rotp.core.impl.stands.magiciansred.client.MRCrossfireHurricaneRenderer;
import rotp.core.impl.stands.magiciansred.client.MRDetectorRenderer;
import rotp.core.impl.stands.magiciansred.client.MRFireballRenderer;
import rotp.core.impl.stands.magiciansred.client.MRRedBindRenderer;
import rotp.core.impl.stands.silverchariot.client.SCRapierRenderer;
import rotp.core.impl.powers.hamon.client.CrimsonBubbleRenderer;
import rotp.core.impl.powers.hamon.client.HamonBubbleBarrierRenderer;
import rotp.core.impl.powers.hamon.client.HamonBubbleCutterRenderer;
import rotp.core.impl.powers.hamon.client.HamonBubbleRenderer;
import rotp.core.impl.powers.hamon.client.HamonCutterRenderer;
import rotp.core.impl.powers.hamon.client.EnergyRippleLayer;
import rotp.core.impl.powers.hamon.client.HamonMasterModel;
import rotp.core.impl.powers.hamon.client.HamonMasterRenderer;
import rotp.core.impl.powers.hamon.client.HamonProjectileShieldRenderer;
import rotp.core.impl.powers.hamon.client.HamonProtectionLayer;
import rotp.core.impl.powers.hamon.client.HamonSpriteRenderer;
import rotp.core.impl.powers.hamon.client.HamonZoomPunchRenderer;
import rotp.core.impl.powers.hamon.client.LeavesGliderRenderer;
import rotp.core.impl.powers.hamon.client.SatiporojaScarfBindingRenderer;
import rotp.core.impl.powers.hamon.client.SatiporojaScarfRenderer;
import rotp.core.impl.powers.hamon.client.SendoHamonOverdriveRenderer;
import rotp.core.impl.powers.hamon.client.SnakeMufflerRenderer;
import rotp.core.impl.powers.hamon.client.TornadoOverdriveEffectLayer;
import rotp.core.impl.powers.hamon.client.TurquoiseBlueOverdriveRenderer;
import rotp.core.impl.powers.pillarman.client.PillarmanBodyPartRenderer;
import rotp.core.impl.powers.pillarman.client.PillarmanBladesLayer;
import rotp.core.impl.powers.pillarman.client.PillarmanBladesModel;
import rotp.core.impl.powers.pillarman.client.PillarmanDivineSandstormRenderer;
import rotp.core.impl.powers.pillarman.client.PillarmanStoneFormLayer;
import rotp.core.impl.powers.pillarman.client.WindCloakLayer;
import rotp.core.impl.powers.vampirism.client.HungryZombieRenderer;
import rotp.core.impl.powers.vampirism.client.SRSEEyesLayer;
import rotp.core.impl.powers.vampirism.client.VampireEyesLayer;
import rotp.core.impl.powers.zombie.client.ZombieLayer;
import rotp.core.impl.npc.rps.client.RockPaperScissorsKidRenderer;
import rotp.core.impl.stands.starplatinum.client.SPStarFingerRenderer;
