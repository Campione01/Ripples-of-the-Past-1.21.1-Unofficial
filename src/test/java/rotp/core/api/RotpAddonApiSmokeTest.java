...
import rotp.core.command.commands.StandRemoveResolveSmokeTest;
import rotp.core.command.commands.PillarmanModeCommandSmokeTest;
import rotp.core.client.polaroid.PolaroidPhotoSourceSmokeTest;
import rotp.core.item.CoreItemResourceSmokeTest;
import rotp.core.item.StandRemoverItemContractSmokeTest;
import rotp.core.mechanics.KnockbackImpactParitySmokeTest;
import rotp.core.mechanics.KnockbackImpactRestSmokeTest;
...
import rotp.core.powersystem.standpower.entity.StandUserGuardSmokeTest;
import rotp.core.powersystem.standpower.entity.StandGuardHurtSoundSmokeTest;
...
import rotp.core.impl.stands.theworld.TimeStopPunchTuningSmokeTest;
import rotp.core.powersystem.ability.AbilityShoutSmokeTest;
import rotp.core.api.stand.StandLossResolveSmokeTest;
import rotp.core.subsystems.timestop.TimeStopFrozenKnockbackSmokeTest;
import rotp.core.subsystems.timestop.TimeStopManualResumeSmokeTest;
...
import rotp.core.subsystems.timestop.TimeStopStartingAbilitySmokeTest;
...
import rotp.core.impl.powers.hamon.abilities.HamonHoldReleaseSmokeTest;
import rotp.core.impl.powers.hamon.abilities.HamonPressShoutSmokeTest;
import rotp.core.impl.powers.hamon.HamonTeacherPowerCheckSmokeTest;
...
public final class RotpAddonApiSmokeTest {
	...
	public static void main(String[] args) {
		...
		StandUserGuardSmokeTest.run();
		StandGuardHurtSoundSmokeTest.run();
		HamonHoldToFireChargeSmokeTest.run();
		HeldConditionRecheckSmokeTest.run();
		HamonHeldConditionSmokeTest.run();
		HamonHoldReleaseSmokeTest.run();
		HamonPressShoutSmokeTest.run();
		HamonTeacherPowerCheckSmokeTest.run();
		...
		TimeStopPunchTuningSmokeTest.run();
		AbilityShoutSmokeTest.run();
		StandLossResolveSmokeTest.run();
		AddonFeatureApiSurfaceSmokeTest.run();
		ResolveModeValueSmokeTest.run();
		ResolveRestSmokeTest.run();
		StandMaxOnLevelSetSmokeTest.run();
		StandRemoveResolveSmokeTest.run();
		TimeStopEntityMovementAuthorizersSmokeTest.run();
		TimeStopFrozenKnockbackSmokeTest.run();
		KnockbackImpactRestSmokeTest.run();
		TimeStopManualResumeSmokeTest.run();
		KnockbackImpactParitySmokeTest.run();
		PillarmanModeCommandSmokeTest.run();
		PolaroidPhotoSourceSmokeTest.run();
