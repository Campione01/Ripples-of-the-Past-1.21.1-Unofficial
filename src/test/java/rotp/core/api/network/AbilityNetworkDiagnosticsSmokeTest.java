...
import rotp.core.api.network.AbilityNetworkDiagnostics.Event;
import rotp.core.api.network.AbilityNetworkDiagnostics.EventWindow;
...
public final class AbilityNetworkDiagnosticsSmokeTest {
	...
	private static void testMainThreadDerivationSourceContract() {
		String client = read(
				"src/main/java/rotp/core/api/network/ClientAbilityNetworkDiagnostics.java");
		String server = read(
				"src/main/java/rotp/core/api/network/ServerAbilityNetworkDiagnostics.java");
